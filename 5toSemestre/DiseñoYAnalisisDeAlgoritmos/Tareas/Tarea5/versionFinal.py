                                                                    ...
                                                                    for mas4 in mascotas4:                                                                            
                                                                        for beb4 in bebidas4:                                                                            
                                                                            for cig4 in cigarros4:                                                                                
                                                                                ...
                                                                                prueba = prueba + 1
                                                                                casas=[]
                                                                                casas.append(Casa(col1, "noruego", mas1, beb1, cig1))
                                                                                casas.append(Casa("azul", nac2, mas2, beb2, cig2))
                                                                                casas.append(Casa(col3, nac3, mas3, "leche", cig3))
                                                                                casas.append(Casa(col4, nac4, mas4, beb4, cig4))
                                                                                casas.append(Casa(col5, nac5, mas5, beb5, cig5))
                                                                                checaCondiciones(casas)
if (c1 and c2 and c3 and c5 and c6 and c7 and c12 and c13):
    fin = time.time() 
    print(f"Tiempo empleado: {fin - inicio} segundos") 
    for c in range:
        if casas[c].Casa.mascota == pez:
            print(casas[c].color, casas[c].nacion, casas[c].mascota, casas[c].bebida, casas[c].cigarro)
